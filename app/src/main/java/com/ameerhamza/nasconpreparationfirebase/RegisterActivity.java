package com.ameerhamza.nasconpreparationfirebase;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(RegisterActivity.this, "Sent Verification Email.", Toast.LENGTH_SHORT);
                            } else {
                                Toast.makeText(RegisterActivity.this, "Sent Verification Email not sent.", Toast.LENGTH_SHORT);
                            }
                        }
                    });
        }
